            ...
            <div className="order-1 lg:order-2">
              <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
                ...
                <p className="mb-6 text-gray-700 leading-relaxed">
                  Mi Gente Bonita Market was founded with a simple mission: to bring authentic Latino products to our community in Wilmington, Delaware. What started as a small family business has grown into a beloved neighborhood market.
                </p>
