              ...
              <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <div className="mb-3">
                      ...
                      <a 
                        ...
                        className="inline-flex items-center text-[#D41414] hover:text-[#891414] mt-1 transition-colors duration-300 text-xs"
                      >
                        Get directions <ExternalLink className="ml-1 h-2.5 w-2.5" />
                      </a>
                    </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a 
                      href="tel:3026913048" 
                      className="inline-flex items-center text-[#3D9C42] hover:text-[#2A6D2E] mt-1 transition-colors duration-300 text-xs"
                    >
                      Call now
                    </a>
                  </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div>
                      <p className="text-gray-700 text-sm mb-0.5">Monday - Saturday: 8:30 AM - 9:00 PM</p>
                      <p className="text-gray-700 text-sm">Sunday: 8:30 AM - 8:00 PM</p>
                    </div>
                  </div>
                </div>
                
                <div className="flex items-start">
                  <div className="bg-[#E7F3FF] text-[#1877F2] p-2 rounded-lg mr-3 flex-shrink-0 w-10 h-10 flex items-center justify-center">
                    <Facebook className="h-5 w-5" />
                  </div>
                  <div>
                    <h4 className="font-bold text-lg mb-2 text-gray-800">Social Media</h4>
                    <a 
                      href="https://www.facebook.com/people/Mi-Gente-Bonita-Market/100078536995749/" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="inline-flex items-center text-[#1877F2] hover:text-[#0A59C0] transition-colors duration-300 text-sm"
                    >
                      Follow us on Facebook <ExternalLink className="ml-1 h-2.5 w-2.5" />
                    </a>
                  </div>
                </div>
              </div>
