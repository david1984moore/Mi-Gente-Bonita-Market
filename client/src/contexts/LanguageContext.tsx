...
const translations = {
  ...
  "about.storyPart1": {
    es: "Mi Gente Bonita Market fue fundado con una misión simple: llevar productos latinos auténticos a nuestra comunidad en Delaware. Lo que comenzó como un pequeño negocio familiar se ha convertido en un mercado de barrio muy querido con dos ubicaciones en Wilmington y Newark.",
    en: "Mi Gente Bonita Market was founded with a simple mission: to bring authentic Latino products to our community in Delaware. What started as a small family business has grown into a beloved neighborhood market with two locations in Wilmington and Newark."
  },
  "about.storyPart2": {
